    ...
    <div className="mt-14 max-w-lg mx-auto p-3 w-full">
      ...
      <div className="text-red-500 flex justify-between mt-5">
        <span
          ...
          className="text-red-500 text-sm underline font-semibold cursor-pointer"
        >
          Delete Account
        </span>
        <span
      ...
      <Modal show={showModal} onClose={() => setShowModal(false)} popup size="md">
        ...
        <Modal.Body>
          <div className="text-center">
            <HiOutlineExclamationCircle className="h-14 w-14 text-red-400 dark:text-red-500 mb-4 mx-auto" />
